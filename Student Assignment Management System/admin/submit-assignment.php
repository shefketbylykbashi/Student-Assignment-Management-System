...
<head>
    ...
    <title>FIEK : Update Assignment </title>
...
{               ?>
                            ...
                            <div class="card-header m-b-20">
                                ...
                                <h4 style="color:#38220f; font-weight:bold">Assignment Number: <?php  echo htmlentities($row->AssignmentNumber);?><strong style="padding-left: 500px">Marks: <?php  echo htmlentities($row->AssigmentMarks);?></strong></h4>
                            ...
                            <div class="row">
                             ...
                             <table class="table table-bordered table-hover data-tables">
                              <tr> <td colspan="4" style="text-align: center;color: #38220f;">Submitted By <?php  echo htmlentities($row->FullName);?>  (Roll Number:  <?php  echo htmlentities($row->RollNumber);?>)</td></tr>
                                <tr>
  ...
  <td colspan="3" style="text-align: center;"><a href="../teacher/assignmentfile/<?php echo $row->AssignmentFile;?>" width="100" height="100" target="_blank"> <strong style="color: #1a0402">View Assignment Paper</strong></a></td>
                            ...
                            <table class="table table-bordered table-hover data-tables">
        <tr ><td colspan="6" style="text-align: center;color: #38220f;"><strong>Submitted Assignment Details</strong></td></tr>
  <tr>
...
<tr>
    ...
    <td colspan="3" style="text-align: center;"><a href="../user/assignanswer/<?php echo $row->AnswerFile;?>" width="100" height="100" target="_blank"> <strong style="color: #38220f;">View Answer Paper</strong></a></td>
