...
<head>
    ...
    <title>FIEK Admin : Dashboard</title>
...
?>
                                        <h4 style="color: #38220f; text-align:center; font-size :2.5em;">Total Course</h4>
                                        <h4 style="color: #38220f; text-align:center; font-size :2.5em;"><?php echo htmlentities($totcourse);?></h4>
...
?>
                                        <h4 style="color: #38220f; text-align:center;font-size :2.5em;">Total Subject</h4>
                                         <h4 style="color: #38220f;text-align:center; font-size :2.5em;"><?php echo htmlentities($totsub);?></h4>
...
?>
                                       <h4 style="color: #38220f; text-align:center;font-size :2.5em;">Total Teacher</h4>
                                         <h4 style="color: #38220f; text-align:center;font-size :2.5em;"><?php echo htmlentities($totteacher);?></h4>
