...
<div class="container" style=" background-color: #dbc1ac; color:#38220f; margin-top: 50px; margin-bottom: 50px;">
	<div class="row">
		<div class="offset-md-3 col-md-6">
			...
			<form method="POST" action="add.php">
                ...
                <button class="btn btn-info"><a style="color:#F1F1F1; margin-bottom:10px" href="index.php" >Back to FAQs</a></button>
			</form>
		</div>
	</div>
