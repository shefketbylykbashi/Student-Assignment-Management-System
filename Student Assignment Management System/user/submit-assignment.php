...
<head>
    ...
    <title>FIEK : Submit Assignment </title>
...
{               ?>
                            <div class="card-header m-b-20">
                                <h4 style="color: #38220f">Assignment Number: <?php  echo htmlentities($row->AssignmentNumber);?><strong style="padding-left: 500px">Marks: <?php  echo htmlentities($row->AssigmentMarks);?></strong></h4>
...
<tr>
    ...
    <td colspan="3" style="text-align: center;"><a href="assignanswer/<?php echo $data->AnswerFile;?>" width="100" height="100" target="_blank"> <strong style="color: #38220f">View Answer Paper</strong></a></td>
