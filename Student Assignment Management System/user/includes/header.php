<div class="header">
        <div class="pull-left">
            <div class="logo"><a href="dashboard.php"><!-- <img src="assets/images/logo.png" alt="" /> --><span>FIEK Student</span></a></div>
...
foreach($results as $row)
{               ?>
                <li class="header-icon dib"><span class="user-avatar"> <?php  echo $row->FullName;?> <i class="ti-angle-down f-s-10"></i></span>
