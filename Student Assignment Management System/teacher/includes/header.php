<div class="header">
        <div class="pull-left">
            <div class="logo"><a href="dashboard.php"><!-- <img src="../assets/images/logo.png" alt="" /> --><span>FIEK Teacher</span></a></div>
...
foreach($results as $row)
{               ?>
                <li class="header-icon dib"><span class="user-avatar"> <?php  echo $row->FirstName;?> <i class="ti-angle-down f-s-10"></i></span>
