...
{               ?>
  ...
  <td colspan="3" style="text-align: center;"><a href="assignmentfile/<?php echo $row->AssignmentFile;?>"  width="100" height="100" target="_blank"> <strong style="font-weight: bold;color: #1a0402">View Assignment Paper</strong></a></td>
