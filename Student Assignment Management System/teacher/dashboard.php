...
<head>
    ...
    <title>FIEK Teacher : Dashboard</title>
...
?>
                                        <h4 style="color: #38220f; text-align:center;font-size :2.5em;">Total Students</h4>
                                        <h4 style="color: #38220f; text-align:center;font-size :2.5em;"><?php echo htmlentities($totuser);?></h4>
...
?>
                                        <h4 style="color: #38220f; text-align:center;font-size :2.5em;">Total Assignment</h4>
                                         <h4 style="color: #38220f; text-align:center;font-size :2.5em;"><?php echo htmlentities($totassign);?></h4>
                        ...
                        <div class="col-md-15">
                            <div class="card">
                                <div class="media"> 
                                <h4 style="color: #38220f; text-align:center;font-size :2.5em;">Contact Us</h4>
                                         <h4 style="color: #38220f; text-align:center;font-size :2.5em;"></h4>
                                         <a class="pull-right" href="sendEmail.php"><h5>Send Email</h5></a>
                                    <!-- <div class="media-left meida media-middle">
