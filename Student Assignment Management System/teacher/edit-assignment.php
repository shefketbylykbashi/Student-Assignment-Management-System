                                ...
                                <div class="col-md-12">
                                    <div class="basic-form">
                                        <div class="form-group image-type">
                                            ...
                                            <a href="assignmentfile/<?php echo $row1->AssignmentFile;?>" width="100" height="100" target="_blank"> <strong style="color: #1a0402">View</strong></a>
<a href="changefile.php?editid=<?php echo $row1->ID;?>" > &nbsp;<strong style="color: #1a0402"> Edit</strong></a>
                                        </div>
                                    </div>
                                </div>
                            </div><?php $cnt=$cnt+1;}} ?>
